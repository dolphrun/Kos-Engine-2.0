...
public:
	...
	REFLECTABLE(AcidLMB, acidLMBDamage, enemyDeathSfxGUID_1, enemyDeathSfxGUID_2, enemyDeathSfxGUID_3)
};
...
inline void AcidLMB::Start() {
	...
	physicsPtr->GetEventCallback()->OnTriggerEnter(entity, [this](const physics::Collision& col) {
		if (ecsPtr->GetComponent<NameComponent>(col.otherEntityID)->entityTag == "Enemy") {
			...
			ecsPtr->GetComponent<EnemyManagerScript>(col.otherEntityID)->enemyHealth -= acidLMBDamage;
